...
.container {
  ...
  align-items: stretch; /* 양쪽 div 높이 맞춤 */
}
...
# Projects
### 1. 투자 포트폴리오 아이디어 공모전 [[1]](https://velog.io/@abc3279/FE-%ED%88%AC%EC%9E%90-%ED%8F%AC%ED%8A%B8%ED%8F%B4%EB%A6%AC%EC%98%A4-%EC%95%84%EC%9D%B4%EB%94%94%EC%96%B4-%EA%B3%B5%EB%AA%A8%EC%A0%84) (May. 2025 ~ Jun. 2025) (Team Project)
장려상 (공동 4등 / 23팀) 수상	KCGI 자산운용 대표이사 수여


<div class="container">
  <div class="left">
  </br>
    Team Leader / Quantitative Analysis
    
  </div>
  <div class="divider"></div>
  <div class="right">
    <ul>
      <li> VIX 지수 고점기와 S&P500 지수 Drawdown 데이터 분석으로 동적 리밸런싱 전략 구성 지원 </li>
      <li> 고객 분석 몬테카를로 시뮬레이션을 활용한 고객 목표 수익률 & 목표 변동성 산출</li>
      <li> bt & Quantstats 패키지를 활용해 커스텀 동적 리밸런싱 전략을 반영한 백테스트 구현 및 포트폴리오 우수성 지표 산출</li>
      <li> 자산 간 상관관계 행렬 바탕 종목 선정 근거 제시</li>
    </ul>
  </div>
</div>

_효율적 투자선, CML, SML 등 투자론을 공부하고 직접 구현해보았으나, 대회 과정에서는 우선순위와 과거 편향 문제로 인해 최종 자료에 포함되지 않음._
...
### 2. 2024 전국 대학생 SW창업 아이디어톤 [[1]](https://velog.io/@abc3279/NLP-%EB%B0%98%EB%A0%A4%EB%8F%99%EB%AC%BC-%ED%9B%88%EB%A0%A8%EC%82%AC-AI-%EC%B1%97%EB%B4%87-%EA%B0%95%ED%98%95%EC%9A%B1-AI-36zr1sj5) [[2]](https://velog.io/@abc3279/NLP-%ED%8E%AB%EB%A1%9C%EC%8A%A4-%EC%8B%AC%EB%A6%AC%EC%83%81%EB%8B%B4-%EC%B1%97%EB%B4%87) (Sep. 2024 ~ Nov. 2024) (Team Project)
장려상 (4등 / 83팀) 수상	한양대학교 총장 수여


<div class="container">
  <div class="left">
  </br>
    AI / Idea Development / Business Planning
    
  </div>
  <div class="divider"></div>
  <div class="right">
    <ul>
      <li> 반려동물과의 추억 기록 및 AI 활용하여 사용자의 펫로스 증후군 예방과 치유를 돕는 플랫폼 아이디어 개발  </li>
      <li> AI 기술 및 통계 위주 전반적인 사업 계획서 작성 </li>
      <li> 프롬프트 엔지니어링 적용한 펫로스 증후군 심리상담 AI 챗봇 구현 </li>
      <li> Langchain RAG 및 프롬프트 엔지니어링 적용해 반려동물의 훈련과 행동 해석을 돕는 반려동물 훈련사 AI 챗봇 구현 </li>
    </ul>
  </div>
</div>
...
### 3. 코로나19 바이러스 프로젝트 [[1]](https://velog.io/@abc3279/CV-%EC%8B%A4%EC%8B%9C%EA%B0%84-%EB%A7%88%EC%8A%A4%ED%81%AC-%EC%96%BC%EA%B5%B4-%EB%B6%84%EB%A5%98-%EC%97%B4%ED%99%94%EC%83%81)[[2]](https://velog.io/@abc3279/%EC%BD%94%EB%A1%9C%EB%82%9819-%ED%99%95%EC%A7%84%EC%9E%90%EC%88%98-%EC%98%88%EC%B8%A1-LSTM)[[3]](https://velog.io/@abc3279/%EB%A7%88%EC%8A%A4%ED%81%AC-%EC%96%BC%EA%B5%B4-%EB%B6%84%EB%A5%98-%EB%AA%A8%EB%8D%B8-AlexNet)[[4]](https://velog.io/@abc3279/%EC%86%90%EA%B8%80%EC%94%A8-%EB%B6%84%EB%A5%98-%EB%AA%A8%EB%8D%B8-LeNet-5)[[5]](https://velog.io/@abc3279/%EC%A3%BC%EC%A0%9C-%ED%83%90%EA%B5%AC-%EB%B0%9C%ED%91%9C%ED%9A%8C)[[6]](https://velog.io/@abc3279/%EB%B9%84%EC%A0%91%EC%B4%89%EC%8B%9D-%EC%B2%B4%EC%98%A8%EA%B3%84-%EC%A0%9C%EC%9E%91) (Aug. 2021 ~ Sep. 2023) (Personal Project)
고등학교 2학년 ~ 대학교 1학년까지의 성장과 당시 중대 사회 문제였던 코로나19 바이러스의 해결을 위한 노력이 담긴 프로젝트로 Cpp & IT 융합 동아리 활동, 교내 진로 프로젝트, 교내 주제 탐구 발표회 출전으로 구성
#### 1) 마스크 착용 감지 및 발열 체크 장치 제작
- 마스크 착용 여부 확인을 위해 LeNet-5, AlexNet 등 CNN 모델 논문 공부 후 구현
- 발열 체크를 위해 아두이노 임베디드 시스템 적용

#### 2) 코로나19 바이러스 일일 확진자수 예측 모델
- LSTM 모델 활용
- 선행 논문 기반 사회 변수 반영 일대일 모델 &rarr; 다대일 모델 개선
...
### 4. 2021 울산 연합 AI · SW 해커톤 [[1]](https://velog.io/@abc3279/2021-%EC%9A%B8%EC%82%B0-AI-SW-%ED%95%B4%EC%BB%A4%ED%86%A4) (Oct. 2021) (Team Project)
울산광역시 중·고등학생 대상 아이디어 및 문제해결 방식 공유 행사 - 학교 대표 참가

<div class="container">
  <div class="left">
  </br>
  Team Leader / Game / Idea Development
    
  </div>
  <div class="divider"></div>
  <div class="right">
    <ul>
      <li> 시각장애인의 이동권 보장을 위한 3가지 프로젝트 제시 </li>
      <li> Unity 활용 시각장애인 체험 기능성 게임(Serious Game) 개발 </li>
    </ul>
  </div>
</div>
...
### 5. PAC-MAN [[1]](https://velog.io/@abc3279/PAC-MAN) (Sep. 2020 ~ Mar. 2021) (Team Project)
Cpp 동아리 활동 중 C++ 활용 CLI 게임 개발 프로젝트

<div class="container">
  <div class="left">
  </br>
  Main / Ghosts Algorithm / UI Development
  ...
  <div class="right">
    <ul>
      <li> CLI 기반 UI 설계 </li>
      <li> 각 유령(블링키, 핑키, 잉크, 클라이드) 특징에 맞는 목표 지점 산정 및 행동 알고리즘(추격, 공포, 포획 모드) 구현 </li>
      <li> 맵 상태를 실시간 반영하여 Euclidean distance 기반 최단거리 알고리즘 적용 </li>
    </ul>
  </div>
</div>
...
- 기타 개인 프로젝트 
  - [한대앞역 시간대별 지하철 혼잡도 분석 (Dec. 2023)](https://velog.io/@abc3279/%EC%A7%80%ED%95%98%EC%B2%A0)
  - [몬티 홀 문제의 검증(Jul. 2022)](https://velog.io/@abc3279/%EB%AA%AC%ED%8B%B0-%ED%99%80-%EB%AC%B8%EC%A0%9C%EC%9D%98-%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%B0%8D%EC%A0%81-%EC%A6%9D%EB%AA%85)
  - [감자 스마트팜 제작 (Jun. 2021)](https://velog.io/@abc3279/ES-%EA%B0%90%EC%9E%90-%EC%8A%A4%EB%A7%88%ED%8A%B8%ED%8C%9C-%EC%A0%9C%EC%9E%91)
  - [공기청정기 제작 (May. 2021)](https://velog.io/@abc3279/%EA%B3%B5%EA%B8%B0%EC%B2%AD%EC%A0%95%EA%B8%B0-%EC%A0%9C%EC%9E%91)
...
- HYAI 학회 NLP 스터디 팀원, 인공지능학회(Mar. 2024 ~ Feb. 2025)
- 미래도시(를) 그린 프로젝트 동아리 팀장, 스마트 시티 & 유비쿼터스 동아리 (Mar. 2022 ~ Feb. 2023)
