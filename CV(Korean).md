...
# Projects
### 1. 투자 포트폴리오 아이디어 공모전 [[1]](Link) (May. 2025 ~ Jun. 2025) (Team Project)
...
<div class="container">
  ...
  <div class="right">
    <ul>
      ...
      <li> bt & Quantstats 패키지를 활용해 커스텀 동적 리밸런싱 전략을 반영한 백테스트 및 포트폴리오 우수성 지표 산출</li>
      <li> 자산 간 상관관계 행렬 바탕 종목 선정 근거 제시</li>
    </ul>
  </div>
</div>

_효율적 투자선, CML, SML 등 자산운용 이론을 공부하고 직접 구현해보았으나, 대회 과정에서는 우선순위와 과거 편향 문제로 인해 최종 자료에 포함되지 않음._
